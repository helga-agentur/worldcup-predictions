...
class ExportAndBaselineTest(unittest.TestCase):
    ...
    def test_published_ledger_freezes_prediction_values_and_builds_static_site(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn('<link rel="canonical" href="/de/spiele/kommende">', de_future_html)
            self.assertIn('<link rel="alternate" hreflang="en" href="/en/matches/future">', de_future_html)
            self.assertIn('<link rel="alternate" hreflang="x-default" href="/en/matches/future">', de_future_html)
            self.assertIn('<a href="/en/matches/future" lang="en"', de_future_html)
            self.assertIn('<link rel="canonical" href="/de/spiele/vergangene">', de_past_html)
            self.assertIn('<link rel="alternate" hreflang="en" href="/en/matches/past">', de_past_html)
            self.assertIn('<link rel="canonical" href="/en/matches/future">', en_future_html)
            self.assertIn('<link rel="canonical" href="/en/matches/past">', en_past_html)
            ...
            self.assertIn('<dt class="summary-label">Vergangene Spiele</dt>', html)
            ...
            self.assertIn(".content-link:hover {\n  color: var(--ink);\n  text-decoration: none;", css)
