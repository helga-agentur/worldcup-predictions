...
class ExportAndBaselineTest(unittest.TestCase):
    ...
    def test_published_ledger_freezes_prediction_values_and_builds_static_site(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn('<div class="bar bar--series" role="img" aria-label="6/10 P.">', html)
            ...
            self.assertIn('<span class="bar__legend-item numeric">6/10 P.</span>', html)
            self.assertIn('<dt class="summary__label">20min Punkte</dt>', html)
            self.assertIn('<dd class="summary__value">5</dd>', html)
            self.assertIn('<div class="bar bar--series" role="img" aria-label="5/5 P.">', html)
            self.assertIn('<span class="bar__legend-item numeric">5/5 P.</span>', html)
