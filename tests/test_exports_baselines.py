...
class ExportAndBaselineTest(unittest.TestCase):
    ...
    def test_published_ledger_freezes_prediction_values_and_builds_static_site(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn('<span class="summary__chip numeric">Ø 6.0/Spiel</span>', html)
            self.assertIn('<dt class="summary__label">20min Punkte</dt>', html)
            self.assertIn('<dd class="summary__value">5</dd>', html)
            self.assertIn('<span class="summary__chip numeric">Ø 5.0/Spiel</span>', html)
            self.assertIn('<dt class="summary__label">Trefferquote</dt>', html)
            self.assertIn('<dd class="summary__value">100%</dd>', html)
            self.assertIn('<dd class="summary__chips" aria-label="0 exakt · 1 richtig · 0 falsch">', html)
            ...
            self.assertIn('<dd class="summary__chips" aria-label="0 exact scores · 1 correct outcomes · 0 wrong outcomes">', en_html)
            self.assertIn('<span class="summary__chip-label">Correct</span>', en_html)
